...
/**
 * Provides the local service interface for PBLinkEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PBLinkEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PBLinkEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.pblink.service.impl.PBLinkEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pb link entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PBLinkEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Indexable(type = IndexableType.REINDEX)
	public PBLinkEntry addPBLinkEntry(
	...
	@Indexable(type = IndexableType.REINDEX)
	public PBLinkEntry updatePBLinkEntry(
