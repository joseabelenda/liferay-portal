...
/**
 * Provides the local service utility for PBLinkEntry. This utility wraps
 * <code>com.liferay.pblink.service.impl.PBLinkEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PBLinkEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.pblink.service.impl.PBLinkEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PBLinkEntry addPBLinkEntry(PBLinkEntry pbLinkEntry) {
		return getService().addPBLinkEntry(pbLinkEntry);
	}

	public static PBLinkEntry addPBLinkEntry(
			String name, String description, String link,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().addPBLinkEntry(
	 ...
	 */
	public static PBLinkEntry createPBLinkEntry(long pbLinkEntryId) {
		return getService().createPBLinkEntry(pbLinkEntryId);
	}
	 ...
	 */
	public static PBLinkEntry deletePBLinkEntry(long pbLinkEntryId)
		throws PortalException {

		return getService().deletePBLinkEntry(pbLinkEntryId);
	}
	 ...
	 * @return the pb link entry that was removed
	 */
	public static PBLinkEntry deletePBLinkEntry(PBLinkEntry pbLinkEntry) {
		return getService().deletePBLinkEntry(pbLinkEntry);
	}
	...
	public static PBLinkEntry fetchPBLinkEntry(long pbLinkEntryId) {
		return getService().fetchPBLinkEntry(pbLinkEntryId);
	}
	 ...
	 */
	public static List<PBLinkEntry> getPBLinkEntries(int start, int end) {
		return getService().getPBLinkEntries(start, end);
	}
	 ...
	 */
	public static int getPBLinkEntriesCount() {
		return getService().getPBLinkEntriesCount();
	}
	 ...
	 * @throws PortalException if a pb link entry with the primary key could not be found
	 */
	public static PBLinkEntry getPBLinkEntry(long pbLinkEntryId)
		throws PortalException {

		return getService().getPBLinkEntry(pbLinkEntryId);
	}
	...
	public static List<PBLinkEntry> listPBLinkEntries() {
		return getService().listPBLinkEntries();
	}

	public static PBLinkEntry updatePBLinkEntry(
			long pbLinkEntryId, String name, String description, String link,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().updatePBLinkEntry(
	 ...
	 */
	public static PBLinkEntry updatePBLinkEntry(PBLinkEntry pbLinkEntry) {
		return getService().updatePBLinkEntry(pbLinkEntry);
	}

	public static PBLinkEntryLocalService getService() {
		return _service;
	}

	private static volatile PBLinkEntryLocalService _service;
