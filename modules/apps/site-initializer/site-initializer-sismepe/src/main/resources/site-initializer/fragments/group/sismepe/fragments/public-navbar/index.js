...
const menuButton = fragmentElement.querySelector('.sismepe-navbar-button');
...
menuButton.addEventListener('click', () => {
	...
	if (myDropdown.classList.contains('show-menu')) {
		return (fragmentElement.querySelector(
			'.sismepe-navbar-button div span'
		).innerText = 'CLOSE');
	}

	fragmentElement.querySelector('.sismepe-navbar-button div span').innerText =
		'MENU';
});
